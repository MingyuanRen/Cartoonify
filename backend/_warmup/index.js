...
/** Generated by Serverless WarmUp Plugin at 2022-08-12T03:15:09.752Z */

const aws = require('aws-sdk');
aws.config.region = 'eu-west-3';
const lambda = new aws.Lambda();
const functions = [{"name":"cartoonify-dev-transformImage","config":{"enabled":true,"payload":"{\"source\":\"serverless-plugin-warmup\"}","concurrency":1}}];
